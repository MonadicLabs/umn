...
umn::UDPTransmitter::UDPTransmitter(uint16_t port, std::string host, std::string multicastInterface )
...
umn::UDPTransmitter::~UDPTransmitter()
{

}

void umn::UDPTransmitter::send(uint8_t *data, uint32_t data_len)
{
    struct sockaddr_in groupSock;
